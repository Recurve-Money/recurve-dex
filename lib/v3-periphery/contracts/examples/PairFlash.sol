...
contract PairFlash is IUniswapV3FlashCallback, PeripheryPayments {
    ...
    function uniswapV3FlashCallback(
        ...
        PeripheryTransferHelper.safeApprove(token1, address(swapRouter), decoded.amount1);
        uint256 amountOut0 =
        ...
        PeripheryTransferHelper.safeApprove(token0, address(swapRouter), decoded.amount0);
        uint256 amountOut1 =
            swapRouter.exactInputSingle(
                ISwapRouter.ExactInputSingleParams({
                    tokenIn: token0,
